...
const DEFAULT_CONFIG = {
  ...
  contact: { title: "Contact", subtitle: "Nous sommes à votre écoute", email: "contact@segande.com", phone1: "+229 01 96 11 37 38", phone2: "", address: "Porto-Novo, Bénin" },
  footer: { aboutText: "Maison de luxe africaine dédiée au bien-être." },
    ...
    return (
      <div className="min-h-screen bg-background-dark flex items-center justify-center">
        <div className="text-center">
          <h2 className="text-primary font-black uppercase tracking-[0.5em] animate-pulse">SÈGANDÉ</h2>
        </div>
      </div>
    );
  }
